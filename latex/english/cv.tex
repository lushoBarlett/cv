...
\leftheader{
  {\LARGE\bfseries\sffamily Luciano Barletta}

  \makefield{\faEnvelope[regular]}{\href{mailto:lushobarlett@gmail.com}{\texttt{lushobarlett@gmail.com}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/luciano-barletta-a8a42519a/}{\texttt{Luciano Barletta}}}
}
...
\makerubric{primary_technologies}
\makerubric{languages}
\makerubric{accomplishments}
\makerubric{notable_projects}
